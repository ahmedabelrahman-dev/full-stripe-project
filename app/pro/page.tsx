  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-6xl h-screen">
      ...
      {isUserLoaded && userSubscription?.status === 'active' && (
        <div className="bg-purple-50 border-l-4 border-purple-400 p-4 mb-8 rounded-md">
        ...
        {PRO_PLANS.map((plan) => (
          ...
          >
            <CardHeader className="grow">
              <CardTitle
                className={`text-2xl ${plan.highlighted ? 'text-purple-500' : 'text-gray-800'}`}
              >
                {plan.title}
              </CardTitle>
              ...
              <Button
                className={`w-full py-6 text-lg ${
                  plan.highlighted
                    ...
                    : 'bg-white text-purple-500 border-2 border-purple-400 hover:bg-purple-50 hover:border-purple-400'
                }`}
